...
export default function StickyCTA() {
  ...
  return (
    ...
    >
      <Link
        href="/configurador"
        className="hidden sm:inline-flex items-center gap-2 bg-[#1a1917] text-white font-semibold pl-5 pr-6 py-3 rounded-full shadow-xl shadow-black/20 hover:bg-[#0d0c0b] transition-all hover:scale-105 active:scale-95 text-sm"
      >
      ...
      <a
        ...
        className="w-14 h-14 bg-[#25D366] hover:bg-[#1ebe57] rounded-full shadow-xl shadow-[#25D366]/30 flex items-center justify-center transition-all hover:scale-105 active:scale-95 relative"
      >
      ...
      <Link
        href="/configurador"
        className="sm:hidden inline-flex items-center gap-2 bg-[#1a1917] text-white font-semibold pl-4 pr-5 py-2.5 rounded-full shadow-xl shadow-black/20 text-xs"
      >
